...
// このスクリプトをGoogle Apps Scriptエディタに貼り付けて使用します。
// 1. Googleドライブで新規 > その他 > Google Apps Script を選択。
// 2. このコードを貼り付けます。
// 3. ファイル > 保存 をクリック。
// 4. 公開 > 新しいデプロイ を選択し、「ウェブアプリ」としてデプロイします。
// 5. 表示されたウェブアプリURLをAppSheetのAutomation設定で使用します。
